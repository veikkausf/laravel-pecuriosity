   ...
   <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start ">
         ...
         <div class="w-full md:w-1/2 bg-gray-300">
            <x-maps-leaflet class="w-full h-full" :centerPoint="['lat' => $currentUserInfo->latitude, 'long' => $currentUserInfo->longitude]" :markers="[['lat' => $currentUserInfo->latitude, 'long' => $currentUserInfo->longitude]]">
            </x-maps-leaflet>
         </div>
         ...
         <div class="flex-col w-full md:w-1/3 mt-2 mr-32 md:mt-0 p-6">
            ...
            <div class="mb-6">
               ...
               <input type="text" id="title" name="title" placeholder="Maximum 100 characters"
